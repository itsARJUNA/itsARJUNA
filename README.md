...
-->
### Main skills
[![My Skills](https://skillicons.dev/icons?i=aws,py,regex,github,git,mongodb,eclipse,java,spring,js,nodejs,react,express,jest,jenkins,cpp,cs,dotnet,html,css,bootstrap,pug,php,androidstudio,blender,ps,notion)](https://skillicons.dev)
